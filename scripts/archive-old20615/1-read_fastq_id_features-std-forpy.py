...
"""BARTI PIPELINE Step 1: Read .FASTQ.gz files and ID features
...
def check_modules():
    try:
        ...
        print e
        print "Please ensure the module has been imported and named correctly     and has not been redefined."
...
def run(db_name=None):
    ...
    with open(output_csv_fpath, open_type) as f:
